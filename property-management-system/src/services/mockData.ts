...
export const mockPermissions: Permission[] = [
  ...
  { id: 165, permCode: 'property:owner:members', permName: '业主成员管理', parentId: 132, path: '/property/owner/members', type: 'menu', sortOrder: 2 },
  { id: 166, permCode: 'property:owner:accounts', permName: '业主账户管理', parentId: 132, path: '/property/owner/accounts', type: 'menu', sortOrder: 3 },
  // 商家管理
